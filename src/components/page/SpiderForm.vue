...
export default {
    ...
    created(){
		...
		if(process.env.NODE_ENV === 'development') {
          this.url = "https://www.xsbiquge.com/15_15338/"
          this.form = {
            bookName: '诡秘之主',
            authorName: '爱潜水的乌贼',
            firstChapterUrl:'https://www.xsbiquge.com/15_15338/8549128.html',
            coverUrl:'https://www.xsbiquge.com/cover/15/15338/15338s.jpg',
            introduce:'蒸汽与机械的浪潮中，谁能触及非凡？历史和黑暗的迷雾里，又是谁在耳语？我从诡秘中醒来，睁眼看见这个世界：\n' +
